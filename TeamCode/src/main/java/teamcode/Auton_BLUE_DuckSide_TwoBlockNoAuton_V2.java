...
@Autonomous(name="BLUE_DuckSide_2BlockNoAuton", group="Linear Opmode")

public class Auton_BLUE_DuckSide_TwoBlockNoAuton_V2 extends LinearOpMode {
...
//            allPoints.add(new CurvePoint(0, 20, 0.4, 0.3, 10, 180, 0));
            ...
            allPoints.add(new CurvePoint(0, 14, 0.6, 0.3, 25, 0, -180));
            allPoints.add(new CurvePoint(-48, 14, 0.6, 0.3, 15, 0, -180));
            allPoints.add(new CurvePoint(-48, 0, 0.6, 0.3, 15, 0, -180));
            allPoints.add(new CurvePoint(-45, -14, 0.6, 0.3, 15, 0, -180));
            allPoints.add(new CurvePoint(-60, -12, 0.6, 0.3, 25, 180, -180));
            allPoints.add(new CurvePoint(-87, -5, 0.6, 0.3, 25, 180, -180));
            allPoints.add(new CurvePoint(-130, -5, 0.6, 0.3, 25, 180, -180));
//            allPoints.add(new CurvePoint(22, 10, 0.6, 0.3, 10, 0, -160));
