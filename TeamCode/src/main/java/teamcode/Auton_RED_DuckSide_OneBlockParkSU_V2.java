...
@Autonomous(name="RED_DuckSide_1Block_ParkSU", group="Linear Opmode")

public class Auton_RED_DuckSide_OneBlockParkSU_V2 extends LinearOpMode {
...
//            shippingHubPark = 30;
        ...
        if (purePursuitPath == 1){
            ...
            allPoints.add(new CurvePoint(-28, 15, 0.6, 0.3, 25, 180, 0));
            allPoints.add(new CurvePoint(-30, 28, 0.6, 0.3, 25, 180, 0));
            allPoints.add(new CurvePoint(-30, 55, 0.6, 0.3, 25, 180, 0));

            myPurePursuitRobotMovement6_Turn_MultiThread.followCurveArm_V2(allPoints, 0, 35, 0, 4,
