...
@Autonomous(name="BLUE_DuckSide_1Block_ParkSU", group="Linear Opmode")

public class Auton_BLUE_DuckSide_OneBlock_ParkSU_V2 extends LinearOpMode {
...
//            shippingHubPark = 30;
        ...
        if (purePursuitPath == 1){
            ...
            allPoints = new ArrayList<>();
            allPoints.add(new CurvePoint(22, 10, 0.5, 0.3, 25, 0, -160));
            allPoints.add(new CurvePoint(22, 20, 0.5, 0.3, 25, 180, -180));
            allPoints.add(new CurvePoint(22, 29, 0.5, 0.3, 25, 180, -180));
            allPoints.add(new CurvePoint(22, 64, 0.5, 0.3, 25, 180, -180));


            myPurePursuitRobotMovement6_Turn_MultiThread_V2.followCurveArm_V2(allPoints, 0, 12, -180, 3,
