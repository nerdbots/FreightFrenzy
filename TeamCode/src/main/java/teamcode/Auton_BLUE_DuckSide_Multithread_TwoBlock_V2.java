...
public class Auton_BLUE_DuckSide_Multithread_TwoBlock_V2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (purePursuitPath == 1){
            ...
            myPurePursuitRobotMovement6_Turn_Multithread.followCurveArm_V2(allPoints, 0, 10, -90, 3, ArmShoulderPositions.INTAKE, shoulderPosition, FingerPositions.GRAB, FingerPositions.GRAB,0.0,1,"none", 0);
